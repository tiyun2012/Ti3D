...
$uri="https://github.com/glfw/glfw/releases/download/3.3.4/glfw-3.3.4.bin.WIN64.zip"
...
$glfwZip=".\glfw-3.3.4.zip"
$glfwRoot=".\glfw-3.3.4"
$glfwList=@("lib-vc2012\glfw3.dll","lib-vc2012\glfw3.lib","lib-vc2012\glfw3dll.lib","lib-vc2012\glfw3_mt.lib")
powershellModule\Expand-SpecificFilesFromZip -zipFilePath $glfwZip -destinationPath $glfwRoot -filesTracked  $glfwList  
